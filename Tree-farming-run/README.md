# Fully Modular Tree Run Framework (All Patches) with Shortest Path & Chat Alerts
...
##  Tree Patch Groups Breakdown

Enable or disable individual Tree Patch groups based on your account progression:

> **How it works:**
> 1. Arriving at **Falador tree patch** for example, open the **"Falador tree"** Alert-Group and open 1 out of 2 groups named "To fruit tree patch or "To Tree patch" and enable your next target (example **"To Catherby" in "To fruit tree patch" alert group**).
> 2. Once at **Catherby Fruit tree patch**, open the **"Catherby Fruit"** Alert-Group and enable your next destination to keep the chain going.

---

## ⚠️ Important Usage Notes

1. **Toggle Off When Done:** Toggle off the main **"Farm run(tree)"** when not actively farming so high-traffic areas (such as the Farming Guild) don't trigger unwanted pathing lines during daily activities. *(Alternatively, you can make the Farming Guild your final destination since that is most likely to get triggered when doing farming contracts)*
